...
![logo-isc2-cissp-square](./assets/images/logo-isc2-cissp-square.png){:height="150px" width="150px"}
![SecurityPlusLogoCertified CE](./assets/images/SecurityPlusLogoCertifiedCE.png){:height="150px" width="150px"}
