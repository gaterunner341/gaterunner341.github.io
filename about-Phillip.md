...
![logo-isc2-cissp-square](./assets/images/logo-isc2-cissp-square.png){:width="25%"} ![SecurityPlusLogoCertified CE](./assets/images/SecurityPlusLogoCertifiedCE.png){:width="25%"}
